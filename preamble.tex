...
% PDFAnnotate: User-defined list of PDFs
% PDFAnnotate: Ensure there are no spaces between the commas and each filename
% PDFAnnotate: Ensure each filename ends in .pdf
% PDFAnnotate: An empty string {""} is not supported and the document will not compile
% PDFAnnotate: No string is supported {}
